...
export class Biomes
{
	static AllBiomes: Biome[] =
		[
			...
			new Biome(1.0, 0.2, 1.0, 0.25, 0.5, 0.0, [new Tree(TreeTypes.SnowTree1, 3)], Enum.Material.Snow, BiomeTypes.SnowForest),
			new Biome(1.0, 0.2, 1.0, 0.0, 1.0, 0.0, [new Church(-5), new Tree(0, 3), new Tree(1, 3), new Tree(2, 3)], Enum.Material.LeafyGrass, BiomeTypes.Forest),
		];
